...
include("create_environment_asteroid.jl")
include("satCVC_const_asteroid.jl")
...
# Run everything
dt_F = readtable("F_asteroid_ellipsoid.csv")
dt_P = readtable("P_asteroid_ellipsoid.csv")
F = Matrix(dt_F)
P = Matrix(dt_P)
ϕ = calcϕ(ψdisc, λdisc, F, P, r);
